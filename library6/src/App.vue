...
export default defineComponent({
  ...
  methods: {
    testme() {
      console.log('[LIBRARY6] App.methods.testme(); Dispatching StartVueAppEvent request for library7')
      window.dispatchEvent(new events.StartVueAppEvent('#app7', '@padcom/mf-test-library7'))
    }
  }
})
</script>
